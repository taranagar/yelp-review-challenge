...
with open('../../../yelp-data/business.json', 'r') as rf:
    for line in rf:
        ...
        if 'GoodForMeal' in line_json['attributes'] and line_json['city'] == 'Las Vegas' and line_json['review_count'] >=15 and line_json['review_count'] <=20 and "Restaurants" in line_json['categories'] and "Fast Food" not in line_json['categories']:
...
with open('../../data/business_ids4.json', 'w') as wf2:
